...
class MinLoadRouting final : public LoadBalancePolicy {
 public:
  MinLoadRouting(std::shared_ptr<InstanceMgr> instance_mgr, const Options& options)
      : LoadBalancePolicy(instance_mgr, options) {};

  virtual ~MinLoadRouting() = default;
